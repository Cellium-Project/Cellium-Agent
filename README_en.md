...
| **Multi-Platform** | Support WebUI, QQ, Telegram, Feishu (Lark), WeChat and other platforms |
...
| Multi-Channel Access | Support external platforms like QQ, Telegram, Feishu (Lark), WeChat, unified message routing, file transfer and injection through ChannelManager |
...
<div align="center">
  <img src="https://agent.cellium.top/github-assets/demo.gif" alt="Quick Start Demo" width="600">
...
Task execution results are automatically pushed to the platform where the task was created (WebUI/QQ/Telegram/Feishu/WeChat).
...
Event trigger results are automatically pushed to the corresponding session (WebUI/QQ/Telegram/Feishu/WeChat).
